...
Head to [www.cloudflare.com/developer-platform/products/workers-ai/](https://www.cloudflare.com/developer-platform/products/workers-ai/) to sign up to CloudflareWorkersAI and generate an API key. Once you've done this set the CF\_AI\_API\_KEY environment variable and the CF\_ACCOUNT\_ID environment variable:
