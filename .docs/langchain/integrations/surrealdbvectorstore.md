...
For detailed documentation of all `SurrealDBVectorStore` features and configurations head to the API reference: [python.langchain.com/api\_reference/surrealdb/index.html](https://python.langchain.com/api_reference/surrealdb/index.html)
