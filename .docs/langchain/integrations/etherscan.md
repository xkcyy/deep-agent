...
* "eth\_balance"
* "erc721\_transaction"
* "erc1155\_transaction"
  The filter is default to normal\_transaction
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/etherscan.mdx)
</Callout>
