...
Head to [featherless.ai/](https://featherless.ai/) to sign up to FeatherlessAI and generate an API key. Once you've done this set the FEATHERLESSAI\_API\_KEY environment variable:
