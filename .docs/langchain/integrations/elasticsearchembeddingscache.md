...
For detailed documentation of all `ElasticsearchEmbeddingsCache` features and configurations, head to the API reference: [python.langchain.com/api\_reference/elasticsearch/cache/langchain\_elasticsearch.cache.ElasticsearchEmbeddingsCache.html](https://python.langchain.com/api_reference/elasticsearch/cache/langchain_elasticsearch.cache.ElasticsearchEmbeddingsCache.html)
