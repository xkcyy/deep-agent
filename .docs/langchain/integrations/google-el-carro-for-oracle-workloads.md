...
* page\_content (type: text)
* langchain\_metadata (type: JSON)
...
For a table with a default schema (page\_content, langchain\_metadata), the
...
* extra\_json\_metadata (type: JSON): for storing other metadata information of the
  fruit.
...
Please look
at [demo\_doc\_loader\_basic.py](https://github.com/googleapis/langchain-google-el-carro-python/tree/main/samples/demo_doc_loader_basic.py)
and [demo\_doc\_loader\_advanced.py](https://github.com/googleapis/langchain-google-el-carro-python/tree/main/samples/demo_doc_loader_advanced.py)
for
