...
The toolkit will read the "STEAM\_KEY" API Key as an environmental variable to authenticate you so please set them here. You will also need to set your "OPENAI\_API\_KEY" and your "STEAM\_ID".
