...
You can connect to TrueFoundry's unified LLM gateway through the [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) interface.
...
Connect to TrueFoundry by updating the [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) model in LangChain:
