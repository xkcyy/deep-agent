...
> Get started using [chat models](/oss/python/langchain/models) via Vertex AI in LangChain.
...
<Info>
  **Google Cloud VertexAI vs Gemini API**
  ...
  The Google Cloud VertexAI integration is separate from the [Google Gemini API](/oss/python/integrations/chat/google_generative_ai/). This page showcases an enterprise version of Gemini through Google Clou Platform (GCP).
</Info>
