...
Since Portkey is fully compatible with the OpenAI signature, you can connect to the Portkey AI Gateway through the [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) interface.
...
We can now connect to the Portkey AI Gateway by updating the [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) model in LangChain
...
The AI gateway extends LangChain's [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) class making it a single interface to call any provider and any model.
...
We only need to modify the [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI) class to use the AI Gateway as above.
