...
```<prompt:user>  theme={null}
Helo, who are you
```

a reply:

````<prompt:assistant>  theme={null}
...
personality = AssistantPersonality(assistant\_name="John", assistant\_role="a pirate")

print(personality.introduce\_your\_self(personality))
